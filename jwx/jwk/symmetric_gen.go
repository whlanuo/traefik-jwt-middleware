...
func (h symmetricKey) KeyType() jwa2.KeyType {
	return jwa2.OctetSeq
}
...
func (h *symmetricKey) iterate(ctx context.Context, ch chan *HeaderPair) {
	...
	pairs = append(pairs, &HeaderPair{Key: "kty", Value: jwa2.OctetSeq})
	if h.algorithm != nil {
...
func (h *symmetricKey) UnmarshalJSON(buf []byte) error {
	...
	if proxy.XkeyType != jwa2.OctetSeq {
	...
	if h.octets = nil; proxy.Xoctets != nil {
		decoded, err := base642.DecodeString(*(proxy.Xoctets))
		if err != nil {
