...
type Headers interface {
	Algorithm() jwa2.SignatureAlgorithm
	ContentType() string
	Critical() []string
	JWK() jwk2.Key
	JWKSetURL() string
...
type stdHeaders struct {
	algorithm              *jwa2.SignatureAlgorithm // https://tools.ietf.org/html/rfc7515#section-4.1.1
	...
	jwk                    jwk2.Key                 // https://tools.ietf.org/html/rfc7515#section-4.1.3
...
type standardHeadersMarshalProxy struct {
	Xalgorithm              *jwa2.SignatureAlgorithm `json:"alg,omitempty"`
	XcontentType            *string                  `json:"cty,omitempty"`
	Xcritical               []string                 `json:"crit,omitempty"`
	Xjwk                    json2.RawMessage         `json:"jwk,omitempty"`
...
func (h *stdHeaders) Algorithm() jwa2.SignatureAlgorithm {
	if h.algorithm == nil {
		return ""
	}
	return *(h.algorithm)
...
func (h *stdHeaders) JWK() jwk2.Key {
	return h.jwk
}
...
func (h *stdHeaders) Set(name string, value interface{}) error {
	switch name {
	case AlgorithmKey:
		var acceptor jwa2.SignatureAlgorithm
...
func (h *stdHeaders) UnmarshalJSON(buf []byte) error {
	...
	if jwkField := proxy.Xjwk; len(jwkField) > 0 {
		set, err := jwk2.ParseBytes([]byte(proxy.Xjwk))
		if err != nil {
...
func (h stdHeaders) MarshalJSON() ([]byte, error) {
	var proxy standardHeadersMarshalProxy
	if h.jwk != nil {
		jwkbuf, err := json2.Marshal(h.jwk)
		if err != nil {
