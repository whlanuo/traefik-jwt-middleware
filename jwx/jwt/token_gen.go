...
import (
	...
	types2 "github.com/whlanuo/traefik-jwt-middleware/jwx/jwt/internal/types"
...
type stdToken struct {
	audience      types2.StringList   // https://tools.ietf.org/html/rfc7519#section-4.1.3
	expiration    *types2.NumericDate // https://tools.ietf.org/html/rfc7519#section-4.1.4
	issuedAt      *types2.NumericDate // https://tools.ietf.org/html/rfc7519#section-4.1.6
	...
	notBefore     *types2.NumericDate // https://tools.ietf.org/html/rfc7519#section-4.1.5
	subject       *string             // https://tools.ietf.org/html/rfc7519#section-4.1.2
	privateClaims map[string]interface{}
}

type stdTokenMarshalProxy struct {
	Xaudience   types2.StringList   `json:"aud,omitempty"`
	Xexpiration *types2.NumericDate `json:"exp,omitempty"`
	XissuedAt   *types2.NumericDate `json:"iat,omitempty"`
	Xissuer     *string             `json:"iss,omitempty"`
	XjwtID      *string             `json:"jti,omitempty"`
	XnotBefore  *types2.NumericDate `json:"nbf,omitempty"`
...
func (t *stdToken) Set(name string, value interface{}) error {
	switch name {
	case AudienceKey:
		var acceptor types2.StringList
		...
		return nil
	case ExpirationKey:
		var acceptor types2.NumericDate
		if err := acceptor.Accept(value); err != nil {
