...
type verifyParams struct {
	alg jwa2.SignatureAlgorithm
	key interface{}
}

func (p *verifyParams) Algorithm() jwa2.SignatureAlgorithm {
	return p.alg
}
...
// WithVerificationKey
func WithVerify(alg jwa2.SignatureAlgorithm, key interface{}) ParseOption {
...
// give keys.
func WithKeySet(set *jwk2.Set) ParseOption {
...
func WithHeaders(hdrs jws2.Headers) ParseOption {
